...
import { formatCurrency, getTimesAgo, toSubstring } from "utils"
import { useTranslation } from "next-i18next"
import { Button, CollapseDropdown, UserAddress } from "components/shared"
...
const SignerRow: FC<SignerRowProps> = ({ index, user, time }) => {
  return (
    <div
      key={index}
