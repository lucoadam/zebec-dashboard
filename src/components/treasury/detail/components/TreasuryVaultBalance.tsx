...
import { showTransferToTreasuryModal } from "features/modals/transferToTreasuryModalSlice"
import TransferToTreasuryModal from "components/modals/TransferToTreasuryModal"
      ...
      <div className="deposited-balance p-6 rounded bg-background-secondary flex flex-col gap-y-6">
        <div className="flex justify-between items-center">
          ...
          <Button
            ...
            onClick={() => dispatch(showTransferToTreasuryModal())}
          />
        </div>
        <div>
