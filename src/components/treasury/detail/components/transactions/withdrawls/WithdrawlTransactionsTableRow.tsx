...
const WithdrawlTransactionsTableRow: FC<InstantTransactionsTableRowProps> = ({
  index,
  transaction,
  activeDetailsRow,
  handleToggleRow
          ...
          <td className="px-6 py-4 min-w-50">
            <div className="text-caption text-content-primary">
              ...
              TreasuryTransactionType.DEPOSIT_TO_TREASURY_VAULT
                ...
                ? `${t("withdraw-from-treasury")}`
                : transaction.transaction_type ===
                  TreasuryTransactionType.WITHDRAW_FROM_TREASURY_VAULT
                ? `${t("withdraw-from-treasury-vault")}`
                : ""}
            </div>
          </td>
                  ...
                  <div className="flex flex-col gap-y-4">
                    ...
                    <div className="flex items-center gap-x-8">
                      ...
                      <div className="flex items-center gap-x-2 text-content-primary">
                        ...
                        />
                        <div
                          data-tip={transaction.approved_by[0].user}
                          className=""
                        >
                          {toSubstring(
                            transaction.approved_by[0].user,
                            5,
                            true
                          )}
                        </div>
...
export default WithdrawlTransactionsTableRow
