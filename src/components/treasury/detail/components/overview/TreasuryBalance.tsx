...
import { showTransferToVaultModal } from "features/modals/transferToVaultModalSlice"
import TransferToVaultModal from "components/modals/TransferToVaultModal"
      ...
      <div className="deposited-balance p-6 rounded bg-background-secondary flex flex-col gap-y-6">
        <div className="flex justify-between items-center">
          ...
          <Button
            ...
            onClick={() => dispatch(showTransferToVaultModal())}
          />
        </div>
        <div>
